"""
Django settings for lkjhgf_347 project.
...
WSGI_APPLICATION = 'lkjhgf_347.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lkjhgf_347 API",
    "DESCRIPTION": "API documentation for lkjhgf_347 App",
    "VERSION": "v1",
}
